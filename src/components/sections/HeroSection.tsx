  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <motion.div
          style={{ y: orbY1 }}
          className="absolute -top-40 -left-40 w-[500px] h-[500px] rounded-full bg-accent-primary/[0.07] blur-[120px]"
        />
        <motion.div
          style={{ y: orbY2 }}
          className="absolute top-1/3 -right-32 w-[400px] h-[400px] rounded-full bg-accent-secondary/[0.05] blur-[100px]"
        />
        <motion.div
          style={{ y: orbY3 }}
          className="absolute -bottom-20 left-1/3 w-[350px] h-[350px] rounded-full bg-accent-warm/[0.04] blur-[100px]"
        />
      </div>
      ...
      >
        ...
        {/* Main heading with word + char animations */}
        <motion.h1
          variants={container}
          initial="hidden"
          animate="visible"
        ...
        {/* Tech stack tags with staggered pop */}
        <motion.div
          initial="hidden"
          animate="visible"
          variants={{
